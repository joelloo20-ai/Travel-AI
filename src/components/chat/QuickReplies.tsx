  ...
  return (
    <div className="ml-9 flex flex-col gap-2.5 animate-fade-up">
          ...
          return (
            <button
              ...
              className={clsx(
                ...
                active
                  ? "border-blue-600 bg-gradient-to-b from-blue-500 to-blue-600 text-white shadow-glow"
      ...
      <button
        ...
        className="w-fit rounded-full bg-gradient-to-b from-ink-800 to-ink-900 px-4 py-1.5 text-sm font-medium text-white shadow-soft transition-opacity hover:opacity-90"
      >
        Continue
      </button>
    </div>
